...
def svm_loss_vectorized(W, X, y, reg):
  ...
  correct_class_score = np.reshape(np.repeat(correct_class_score, num_classes, axis = 0), (y.shape[0],num_classes))
  ...
  # loss.                                                                     #
  #############################################################################
  grad_count  = (margin > 0).sum(1)  
  margin[margin <= 0] = 0
  margin[margin > 0] = 1  
  margin[np.arange(len(margin)),y] = -grad_count
